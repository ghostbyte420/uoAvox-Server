...
namespace Server.Engine.Facet
{
	...
	public class LoginComplete : Packet
	{
		public LoginComplete() : base(0x3F)
		{
			...
			m_Stream.WriteAsciiFixed(FacetEditingSettings.UniqueServerID, FacetEditingSettings.UniqueServerID.Length);

			// byte 015 to 042  -  shard identifier
			var remainingLength = 28 - FacetEditingSettings.UniqueServerID.Length;
